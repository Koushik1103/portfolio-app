    ...
    <div className="about">
      ...
      <div className="about__paragraph">
        <p>
          ...
          journey. 🚀 I'm your go-to backend developer, turning code into magic.
          When I'm not geeking out over lines of code, you'll catch me in the
          virtual worlds of Resident Evil and Call of Duty – absolute classics,
          right? I also kick back with some badminton to keep things
          interesting.
        </p>
        <p>
          ...
          Originally from the lively city of Chennai in Tamil Nadu, India, I've
          been a local forever. 🌆
        </p>
        <p>
          If you're into games, tech, or just up for a chat, hit me up! Links
          are on the side – let's connect and swap stories about the digital and
